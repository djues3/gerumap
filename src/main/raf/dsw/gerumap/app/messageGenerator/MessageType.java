...
public class MessageType {
	...
	public static final String NODE_FOR_DELETION_MUST_BE_SELECTED = "Node for deletion must be selected";
	public static final String PROJECT_EXPLORER_CANNOT_BE_REMOVED = "Project Explorer cannot be removed";
}
